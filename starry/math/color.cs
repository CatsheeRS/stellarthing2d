...
public struct @color(byte r, byte g, byte b, byte a) {
    ...
    public static implicit operator color((byte, byte, byte) m) => new(m.Item1, m.Item2, m.Item3, 255);
    public static implicit operator color((byte, byte, byte, byte) m) => new(m.Item1, m.Item2, m.Item3, m.Item4);
